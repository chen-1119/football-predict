...
const high = evaluateHistoricalRecommendationGuard({ ...base, odds: 2.18 });
...
assert.equal(formalLowMid.blockers.includes("historical-high-sp-cooling"), false);
