...
const listSupplement = list.indexOf('getListHandicapSupplement(', listGuard);
...
check('handicap supplement is restricted to pre-result state', hasAll(list, [
...
check('formal recommendation display fails closed after sale cutoff', hasAll(
  read('src/services/displayRecommendation.ts'),
  [
