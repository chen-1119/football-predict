...
equal(resultOnlySignal.lineups.sourceObservedAt, preObservedAt, "result does not refresh lineups");
...
equal(postCutoffSignal.lineups.usableForPreMatch, false, "post-cutoff lineups fail closed");
