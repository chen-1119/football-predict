...
const websiteUrl = process.env.WEBSITE_URL || "https://170.106.75.73/";
...
<body>
  <main class="wrap">
    ...
    <div class="footer">
      <span>网站来源：https://170.106.75.73/</span>
