...
1. Confirm the public address is still `170.106.75.73`.
...
```bash
TLS_VERIFY_BASE_URL=http://170.106.75.73 \
...
uses a fixed `308` target of `https://170.106.75.73` rather than reflecting the
request `Host` header.
...
```bash
TLS_VERIFY_BASE_URL=https://170.106.75.73 \
TLS_VERIFY_MODE=strict \
TLS_EXPECT_IP=170.106.75.73 \
